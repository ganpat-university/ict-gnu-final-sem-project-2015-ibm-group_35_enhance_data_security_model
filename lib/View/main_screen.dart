...
class _MainScreenState extends State<MainScreen> {
  ...
  authenticateMeSignUp(widget, BuildContext context,
    ...
    if (userCredential.additionalUserInfo!.isNewUser) {
      ...
      Navigator.pushAndRemoveUntil(
          ...
          (route) => false);
      await prefs.setBool('resetPassword', true);
    } else {
      Fluttertoast.showToast(
  ...
  authenticateMeSignIn(widget, BuildContext context,
      ConfirmationResult confirmationResult, String otp) async {
    UserCredential userCredential = await confirmationResult.confirm(otp);
    User? user;
    user = userCredential.user;
    ...
    if (userCredential.additionalUserInfo!.isNewUser) {
      Fluttertoast.showToast(
        msg: 'Please register this mobile number',
        textColor: AppColors.white,
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
        backgroundColor: AppColors.white,
  ...
  Widget buildSendOTPBtn(String text) => Padding(
        padding: const EdgeInsets.fromLTRB(90, 13, 90, 13),
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            shape: RoundedRectangleBorder(
          ...
          onPressed: () async {
            ...
            temp = await sendOTP(mobileController.text);
          },
          child: Padding(
            padding: const EdgeInsets.fromLTRB(90, 13, 90, 13),
            child: Text(
  ...
  Widget buildSubmitBtn(BuildContext context, String text) => Padding(
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            await authenticateMeSignIn(widget, context, temp, otpToSignIn.text);
          },
          child: Padding(
            padding: const EdgeInsets.fromLTRB(90, 13, 90, 13),
            child: Text(
